    ...
    <div className="relative shrink-0">
      ...
      <nav className="flex items-end pb-2 pt-5 bg-card/40 backdrop-blur-xl border-t border-white/10 shadow-[0_-1px_0_rgba(255,255,255,0.05)]">
        ...
        <div className="flex flex-1 justify-around">
          <button onClick={() => navigate("search")} className="flex flex-col items-center gap-0.5 px-3 active:opacity-70 transition-opacity">
          ...
          <button onClick={() => navigate("drawer")} className="flex flex-col items-center gap-0.5 px-3 active:opacity-70 transition-opacity">
        ...
        <div className="flex flex-1 justify-around">
          <button onClick={() => navigate("focus")} className="flex flex-col items-center gap-0.5 px-3 active:opacity-70 transition-opacity">
          ...
          <button onClick={() => navigate("home")} className="flex flex-col items-center gap-0.5 px-3 active:opacity-70 transition-opacity">
